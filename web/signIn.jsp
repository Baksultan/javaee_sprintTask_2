...
<div class="container" style="width: 1000px">
    ...
    <div style="padding: 20px; display: flex; flex-direction: column; align-items: center;">
        ...
        <% } else if (request.getAttribute("incorrect_password") != null) { %>
            <div class="alert alert-danger alert-dismissible fade show" role="alert" style="width: 820px;">
        ...
        <form action="/sign_in" method="post">
            ...
            <div class="mb-4 mt-3">
                ...
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" name="email" <%if (request.getAttribute("email") != null) {%>value = <%=request.getAttribute("email")%><%}%>>
            </div>
